...
";
    ...
    /// </remarks>
    public event NpgsqlBatchCommandCompletedEventHandler? BatchCommandCompleted;

    internal void OnBatchCommandCompleted(NpgsqlBatchCommand batchCommand)
        => BatchCommandCompleted?.Invoke(this, new NpgsqlBatchCommandCompletedEventArgs(batchCommand));
    #endregion
...
public delegate void NpgsqlBatchCommandCompletedEventHandler (object sender, NpgsqlBatchCommandCompletedEventArgs e);
...
/// </summary>
public sealed class NpgsqlBatchCommandCompletedEventArgs : EventArgs
{
    /// <summary>
    ...
    internal NpgsqlBatchCommandCompletedEventArgs(NpgsqlBatchCommand batchCommand) => BatchCommand = batchCommand;
}
