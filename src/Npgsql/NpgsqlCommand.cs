...
";
        ...
        internal void OnStatementCompleted(NpgsqlStatement statement)
            => StatementCompleted?.Invoke(this, new NpgsqlStatementCompletedEventArgs(statement));
    ...
    public delegate void StatementCompletedEventHandler (object sender, NpgsqlStatementCompletedEventArgs e);
    ...
    /// </summary>
    public sealed class NpgsqlStatementCompletedEventArgs : EventArgs
    {
        /// <summary>
        ...
        internal NpgsqlStatementCompletedEventArgs(NpgsqlStatement statement) => Statement = statement;
    }
